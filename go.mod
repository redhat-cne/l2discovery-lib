...
require (
	...
	github.com/k8snetworkplumbingwg/ptp-operator v0.0.0-20260318181654-4ec2565ae595
...
// Pin openshift/api and openshift/client-go to commits compatible with k8s 0.35.x
// and structured-merge-diff/v6.
replace (
